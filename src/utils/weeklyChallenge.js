...
// Trae los retos activos hoy (como mucho uno por duration_type: "diario"
// y "semanal" pueden estar vigentes al mismo tiempo, nunca dos del mismo
// tipo) + progreso del usuario actual en cada uno. Todo el cálculo (qué
// cuenta como "verificada", ventana de fechas, etc.) vive server-side en
// get_weekly_challenge_progress() / compute_metric_for_user() — acá no se
// recalcula nada, solo se pinta lo que la RPC ya devolvió.
// Devuelve [] si no hay ningún reto activo hoy.
