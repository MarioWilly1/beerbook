...
export const BADGE_DEFS = [
  {
    ...
    icon: "🍺",
    nombre: "Catador",
    descripcion: "Cervezas verificadas (con foto)",
    stat: "verifiedBeers",
  ...
  },
  {
    ...
    icon: "🌍",
    nombre: "Viajero",
    descripcion: "Países distintos (entradas verificadas)",
    stat: "verifiedDistinctCountries",
  ...
  },
  {
    ...
    icon: "🎨",
    nombre: "Explorador",
    descripcion: "Estilos distintos (entradas verificadas)",
    stat: "verifiedDistinctStyles",
  ...
  },
  {
    ...
    icon: "✍️",
    nombre: "Crítico",
    descripcion: "Comentarios en entradas verificadas",
    stat: "verifiedWithComments",
    thresholds: { bronce: 5, plata: 20, oro: 50, platino: 100 },
  },
];
